...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": [f"s3://aws-de-bootcamp-playground/weather-data/date={current_date}/weather_api_data.csv"],
        "recurse": True,
    },
...
redshift_output = glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://aws-de-bootcamp-playground/redshift-temp-data/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "arn:aws:iam::407717415880:role/RedshiftRole",
